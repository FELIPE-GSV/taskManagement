...
urlpatterns = [
    ...
    path('findTaskById/<str:identifier>', views.get_task_by_id, name="get_task_by_id"),
    path('deleteTaskById/<str:identifier>', views.delete_task_by_id, name="delete_task_by_id"),
